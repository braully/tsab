...
./mvnw -q -Dexec.executable=java -Dexec.classpathScope=runtime -DskipTests=true org.codehaus.mojo:exec-maven-plugin:3.0.0:exec "-Dexec.args=-classpath %classpath ee.ioc.phon.tsab.cli.TsabCLI ${1} ${2+\"$2\"}"
